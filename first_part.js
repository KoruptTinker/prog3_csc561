  ...
  if (inputTriangles != String.null) {
    ...
    for (var whichSet = 0; whichSet < inputTriangles.length; whichSet++) {
      ...
      for (whichSetVert = 0; whichSetVert < inputTriangles[whichSet].vertices.length; whichSetVert++) {
        ...
        colorArray.push(inputTriangles[whichSet].material.diffuse[0], inputTriangles[whichSet].material.diffuse[1], inputTriangles[whichSet].material.diffuse[2]);
      }
...
function renderTriangles() {
  ...
  mat4.perspective(projectionMat, Math.PI / 2, aspectRatio, 0.5, 100);
